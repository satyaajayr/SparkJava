...
public class ProblemStatement2 {
	...
	public static void main(String[] args) {
		...
		SparkSession session = SparkSession.builder().appName("ProblemStatement2").master("local[*]").getOrCreate();		
		...
		Dataset<Row> filteredRatings = ratingsWithoutHeader.filter("RatecodeID==4");
